 ...
 * @return a pair of width window size to height window size
 */
@Composable
fun Activity.rememberWindowSizeClass(): Pair<WindowSize, WindowSize> {
    ...
    return getWindowWidthSizeClass(windowDpSize) to getWindowHeightSizeClass(windowDpSize)
}

/**
 * Remembers the width [WindowSize] class for the window corresponding to the current window metrics.
 */
@Composable
fun Activity.rememberWindowWidthSizeClass(): WindowSize {
    // Get the size (in pixels) of the window
    val windowSize = rememberWindowSize()
    ...
    // Calculate the window size class
    return getWindowWidthSizeClass(windowDpSize)
}

/**
 * Remembers the  height [WindowSize] class for the window corresponding to the current window metrics.
 */
@Composable
fun Activity.rememberWindowHeightSizeClass(): WindowSize {
    // Get the size (in pixels) of the window
    val windowSize = rememberWindowSize()
    ...
    // Calculate the window size class
    return getWindowHeightSizeClass(windowDpSize)
}
 ...
 */
@VisibleForTesting
fun getWindowWidthSizeClass(windowDpSize: DpSize): WindowSize = when {
 ...
 */
@VisibleForTesting
fun getWindowHeightSizeClass(windowDpSize: DpSize): WindowSize = when {
